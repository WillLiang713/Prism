...
![Prism 聊天主界面](./screenshots/prism-chat-overview.png)

### 服务配置

![Prism 服务配置](./screenshots/prism-settings-services.png)

### 联网搜索配置

![Prism 联网搜索配置](./screenshots/prism-settings-web-search.png)
