                    ...
                    async for chunk in response.aiter_bytes():
                        ...
                        for line in lines:
                            ...
                            try:
                                ...
                                # 解析响应块
                                if provider_mode == "anthropic":
                                    parsed = StreamParser.parse_anthropic_chunk(
                                        chunk_json
                                    )
                                else:
                                ...
                                if parsed.get("tool_calls") and request.enableTools:
                                    for tool_call in parsed["tool_calls"]:
                                        ...
                                        if "id" in tool_call:
                                            tool_calls_buffer[idx]["id"] = tool_call[
                                                "id"
                                            ]
                                        ...
                                        if "function" in tool_call:
                                            ...
                                            if (
                                                ...
                                                tool_calls_buffer[idx]["name"] += func[
                                                    "name"
                                                ]
                                            if (
                                                "arguments" in func
                                ...
                                if isinstance(parsed_result, dict):
                                    ...
                                    if parsed_result.get("error"):
                                        ...
                                        result_summary = json.dumps(
                                            parsed_result, ensure_ascii=False
                                        )
                                else:
                                ...
                                for line in lines:
                                    ...
                                    try:
                                        ...
                                        if provider_mode == "anthropic":
                                            ...
                                            parsed = StreamParser.parse_openai_chunk(
                                                chunk_json
                                            )
