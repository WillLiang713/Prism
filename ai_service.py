...
class ChatRequest(BaseModel):
    ...
    exaSearchType: str = Field(default="auto")  # Exa 搜索模式（neural|fast|auto|deep|deep-reasoning|deep-max|instant）
                    ...
                    while tool_calls_buffer and request.enableTools:
                        ...
                        for idx, tool_call in sorted(tool_calls_buffer.items()):
                            ...
                            if tool_name == "tavily_search":
                                ...
                                args["max_results"] = resolved_max_results
                                allowed_exa_types = {
                                    "neural", "fast", "auto", "deep", "deep-reasoning", "deep-max", "instant"
                                }
